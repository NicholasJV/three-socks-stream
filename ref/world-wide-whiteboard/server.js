...
// path has methods to make working with directory paths easier
var path = require('path');
// obvi we need an http server:
var http = require('http');
var server = http.createServer();
// hook up express to our server of course:
var express = require('express');
var app = express();

// here we bring in our socket library woo hoo!
